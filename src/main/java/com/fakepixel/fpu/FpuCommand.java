...
public class FpuCommand extends CommandBase {
    ...
    private static final String DEVELOPER_IGN = "Devans_h";
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equalsIgnoreCase("reset") && args.length >= 2) {
            ...
            if (!currentInGameName.equalsIgnoreCase(DEVELOPER_IGN)) {
                return; 
            }
            ...
            CompletableFuture.runAsync(() -> {
                try {
                    ...
                    if (response == 200 && Minecraft.getMinecraft().thePlayer != null) {
                        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.LIGHT_PURPLE + "[FPU-Dev] Full wipe successful! Refresh cache on next item hover."));
                    }
                } catch (Exception e) {
